...
class FinHealthTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        controller = FinHealthController(share: share)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "finHealthData", for: indexPath) as! FinHealthCell
        ...
        if indexPath.row == 0 {
            ...
            let labelledChartData = LabelledChartDataSet(title: "Moat values", chartData: chartData)
            cell.configure(primaryData: labelledChartData)
        }
