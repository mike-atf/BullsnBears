...
// 17
    ...
    */
    ...
    public func returnIValueNew() -> (Double?, [String]) {
        ...
        guard let incomeTax = share?.income_statement?.incomeTax.valuesOnly(dateOrdered: .ascending)?.last else {
            errors.append("income tax data missing")
            return (nil,errors)
        }
...
//        if let mc = share?.key_stats?.marketCap.datedValues(dateOrder: .ascending) {
//            print("mcap:")
//            for i in mc {
//                print(i)
//            }
