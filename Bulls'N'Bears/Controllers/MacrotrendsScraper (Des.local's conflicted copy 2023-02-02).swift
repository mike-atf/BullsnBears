        ...
        for title in rowTitles {
            ...
            if  let rowText = extractRow(tableText: tableText, rowTitle: title) {
                ...
                for pair in pairs {
                    ...
                    var factor = 1.0
                    if["Revenue","Net Income","Long Term Debt","Cash Flow From Operating Activities", "Net Change In Property, Plant, And Equipment"].contains(title) {
                        factor = 1_000_000
                    } else if title == "ROI - Return On Investment" {
                        factor = 1/100
                    }
